...
def plot_data(in_data, chr_len, out_pic):
	...
	color_db = {'common': 'blue', 'uniq98': 'red', 'uniq90': 'orange'}
	label_db = {'common': 'Common', 'uniq98': 'Uniq 100%-98%', 'uniq90': 'Uniq 98%-90%'}
	...
	if len(chr_list)==1:
		...
		x_ticks = []
		x_labels = []
		for i in range(0, int(chr_len_db[chrn]/1e7)+1):
			x_ticks.append(i*1e7)
